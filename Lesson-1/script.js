...
class GoodsList {
    ...
    fetchGoods () {
        this.goods = [
            { title : 'Зефир', price : 300, src : 'https://place-hold.it/200x150' },
            { title : 'Маршмеллоу', price : 400, src : 'https://place-hold.it/200x150' },
            { title : 'Маршмеллоу на палочке', price : 500, src : 'https://place-hold.it/200x150' }
